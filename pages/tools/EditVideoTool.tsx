    ...
    <div ref={rootRef} className={`${styles.root} ${isCookOpen ? styles.rootCookOpen : ""}`} onMouseMove={handleRootMouseMove}>
      ...
      {panel === null && (
        <button
          ...
          aria-controls="edit-video-start-create"
      ...
      {isCookLayerVisible && (
        <div id="edit-video-start-create" className={`${styles.cookOverlay} ${styles.cookOverlayOpen}`} aria-hidden={!isCookLayerVisible}>
          <button
            type="button"
              ...
              <div className={`${styles.promptEditor} ${styles.cookPromptEditor}`}>
                ...
                {ENABLE_EDITVIDEO_MULTISHOT && isStoryboardMode ? (
                  ...
                  <MentionTextarea
                    ...
                    placeholder={
                      isSeedanceModel
                        ? "Describe qué cambiar y qué conservar… (El video base es @Video1. Usa @Image1..@Image9 como referencias opcionales)."
                        : model === "kling-o3-ref-to-video-pro"
              ...
              {ENABLE_EDITVIDEO_MULTISHOT && model === "kling-o3-ref-to-video-pro" && (
                ...
                >
                  ...
                  <span className={styles.controlBtnMeta}>
                    {multishotEnabled ? `(${multishotMode === "customize" ? shots.length : multishotMode})` : ""}
                  </span>
                </button>
              )}
            </div>
